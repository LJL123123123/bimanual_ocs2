...
| /distance_markers | 距离/约束等可视化(MarkerArray) | visualization_msgs/MarkerArray | visualization_msgs/Marker[] markers; std_msgs/Header header; uint32 seq; time stamp; string frame_id; string ns; int32 id; int32 type; int32 action; geometry_msgs/Pose pose; geometry_msgs/Point position; float64 x; floa… | /opt/ros/noetic/share/visualization_msgs/msg/MarkerArray.msg | pub:/mobile_manipulator_dummy_mrt_node; sub:/rviz | 持续(~400.9 Hz) | 22932 B | 8978.8 KiB/s |
...
| /mobile_manipulator/optimizedPoseTrajectory | 优化轨迹可视化(PoseArray) | geometry_msgs/PoseArray | std_msgs/Header header; uint32 seq; time stamp; string frame_id; geometry_msgs/Pose[] poses; geometry_msgs/Point position; float64 x; float64 y; float64 z; geometry_msgs/Quaternion orientation; float64 x; float64 y; flo… | /opt/ros/noetic/share/geometry_msgs/msg/PoseArray.msg | pub:/mobile_manipulator_dummy_mrt_node; sub:/rviz | 持续(~399.0 Hz) | 249 B | 97.0 KiB/s |
| /mobile_manipulator/optimizedStateTrajectory | 优化状态可视化(MarkerArray) | visualization_msgs/MarkerArray | visualization_msgs/Marker[] markers; std_msgs/Header header; uint32 seq; time stamp; string frame_id; string ns; int32 id; int32 type; int32 action; geometry_msgs/Pose pose; geometry_msgs/Point position; float64 x; floa… | /opt/ros/noetic/share/visualization_msgs/msg/MarkerArray.msg | pub:/mobile_manipulator_dummy_mrt_node; sub:/rviz | 持续(~399.0 Hz) | 542 B | 211.2 KiB/s |
